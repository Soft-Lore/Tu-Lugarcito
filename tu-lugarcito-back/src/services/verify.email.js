...
const get_template = (name, token) => {
  return `     
    ...
    <div style="margin-left: 100px; margin-top: 20px; width: 200px; background-color: #90be6d; padding: 10px; border-radius: 10px; text-align: center" class="buttom">
        <a style="text-decoration: none; color: white; text-transform: uppercase;" href="http://localhost:465/api/user/confirm/${token}">Confirmar cuenta</a>
    </div>
    </div>
  `;
};
