...
export default function Footer() {
    return (
                ...
                <div className="footer-items">
                    <a href="https://facebook.com/Tu_Lugarcito-103740648742221/?ref=pages_you_manage" className="footer-ancla footer-ancla__fb">
                    ...
                    <a href="https://instagram.com/tu_lugarcito07/?hl=es" className="footer-ancla footer-ancla__ig">
                    ...
                    <a href="https://vm.tiktok.com/ZMRGuqA3t/" className="footer-ancla footer-ancla__tk">
